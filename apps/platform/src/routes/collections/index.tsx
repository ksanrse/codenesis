...
function CollectionsPage() {
  ...
  const courseCollections = collections.filter((collection) => collection.kind === "course");
  const taskCollections = collections.filter((collection) => collection.kind !== "course");
