...
<button
  type="button"
  on:click={onClick}
  class="group flex min-h-[122px] w-full flex-col items-start gap-3 rounded-[var(--radius-xl)] border border-border bg-card px-4 py-4 text-left text-content shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition-colors duration-150 ease-[var(--ease-standard)] hover:border-border-strong hover:bg-surface-muted focus-visible:outline focus-visible:outline-2 focus-visible:outline-[color:var(--focus-ring)] focus-visible:outline-offset-2"
>
  ...
  <div class="flex flex-wrap gap-2" aria-label="Теги задачи">
