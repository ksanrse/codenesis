...
<article class={`relative grid min-w-[190px] cursor-pointer gap-1 rounded-md border bg-card px-5 py-4 text-foreground shadow-panel transition ${selected ? "border-border-strong bg-surface-muted shadow-float" : "border-border hover:border-border-strong hover:bg-surface"}`}>
